...
class SoftActorCritic(object):
    ...
    def __init__(self, policy, state_dim, action_dim, replay_buffer,
        ...
        # set up the networks
        self.value_net        = ValueNetwork(state_dim, hidden_dim,print_nets=print_nets,init_w=init_w).to(self.device)
        self.target_value_net = ValueNetwork(state_dim, hidden_dim,print_nets=print_nets,init_w=init_w).to(self.device)
        self.policy_net       = policy

        self.soft_q_net = SoftQNetwork(state_dim, action_dim, hidden_dim,init_w=init_w).to(self.device)
